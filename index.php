...
function validate()
{
  ...
  //   Password validation -  atleast one capital letter  atleast one lower case letter  atleast one digit atleast one special character minimum eight characters in length 
    var passregex= /(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*\W).{8,}/;
    if(passregex.test(password)==false)
    {
        alert("Should contain atleast one capital letter , one lower case letter , one digit ,one special character  and minimum eight characters in length");
        return false;
    }
    return true;
}
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://thumbs.dreamstime.com/b/hospital-logo-template-hospital-logo-template-117487677.jpg" alt="" style="border-radius:50%"/>
                        <h3>Welcome</h3>
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <form method="post" action="func2.php" onsubmit="return validate()" >
